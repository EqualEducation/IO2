...
Router.route('/search/resource/:resource_type', {
  template: 'view_resources_list',
  action: function() {
    this.render()
  },
  data: function() {
    var resources =  Resources.find({'type':this.params.resource_type}).fetch();
    var data = new Object();
    data.resourceType = this.params.resource_type;
...
Router.route('/explore', {
  ...
  waitOn: function() {
    return [this.subscribe('activities-explore-data'),
            this.subscribe('curricula-explore-data')];
  }
});
//***************************************************************************
//********************************* CREATE **********************************
...
Router.route('/contact', {
  ...
  template: 'contact',
  // action: function() {
  //   Session.set('currentAboutPageId', 'about5');
  // }
});
